    ...
    <section class="head-section">
        <nav class="navbar">
            ...
            <div class="nav-item-list">
                <ul class="nav-items">
                    ...
                    <li class="item"><a href="how it works.php">How it Works</a></li>
                    </ol>
            </div>
        ...
        <section class="head-section-wrapper">
            <div class="first-half">
                <h3>This is work by online platform.Online doctor appointment system by register a patients. </h3>
                <h4>Click on <a href="register.php">Register</a></h4>
